...
TT	   BIT	P3.7;Hien thi trang thai binh thuong/cai dat
;~~~~~~~~~~~~~~~~ BIEN CAI DAT~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

COU		EQU	32H		;Thu tu bien
DLO		EQU	33H		;Chong dao dong dien(mat dien tam thoi) 	(MIN=0s,MAX=60s)
DLF		EQU	34H		;Chong dao dong dien(co dien tam thoi)		(MIN=0s,MAX=60s)
TGD		EQU	35H		;thoi gian de								(MIN=1s,MAX=10s)
SLD		EQU	36H		;so lan de									(MIN=1lan,MAX=5lan)
...
REP		EQU	39H		;Thoi gian co the khoi dong lap lai may phat(MIN=1S,MAX=90s)
...
TIME	EQU 50H		;BIEN THAI DOI TAN SO QUET LED
;~~~~~~~~~~~~~~~~~~~~~~~~~BIT NHO DAC BIET~~~~~~~~~~~~~~~~~~~~~~~~~
...
SUB_CB3:
		...
		CALL EFECT1
		JMP SUBF_CB1			;NHAY DEN "CHUONG TRINH THU 3"
SUB_DLF:
		MOV VAR2,#0FH
		MOV TEM3,DLF
		CALL DELAYHTS
